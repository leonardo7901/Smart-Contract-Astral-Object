...
const opcodes_1 = __webpack_require__(489537);
...
const { default: ENS, getEnsAddress } = __webpack_require__(426143);
/**
...
class ProjectDecoder {
    ...
    reverseEnsResolve(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (name !== null) {
                ...
                const checkAddress = yield this.ens.name(name).getAddress();
    ...
    decodeTransactionWithAdditionalContexts(transaction, additionalContexts = {}, additionalAllocations) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const decoder = (0, codec_1.decodeCalldata)(info, isConstructor);
            ...
            if (decoding.kind === "function") {
                decoding = yield this.withMulticallInterpretations(decoding, transaction, additionalContexts, additionalAllocations);
            }
            return decoding;
        });
    }
    ...
    withMulticallInterpretations(decoding, transaction, additionalContexts = {}, additionalAllocations) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            decoding.interpretations.multicall = yield this.interpretMulticall(decoding, transaction, additionalContexts, additionalAllocations);
            decoding.interpretations.aggregate = yield this.interpretAggregate(decoding, transaction, additionalContexts, additionalAllocations);
            decoding.interpretations.tryAggregate = yield this.interpretTryAggregate(decoding, transaction, additionalContexts, additionalAllocations);
            decoding.interpretations.deadlinedMulticall =
                yield this.interpretDeadlinedMulticall(decoding, transaction, additionalContexts, additionalAllocations);
            decoding.interpretations.specifiedBlockhashMulticall =
                yield this.interpretBlockhashedMulticall(decoding, transaction, additionalContexts, additionalAllocations);
            return decoding;
        });
    }
    interpretMulticall(decoding, transaction, additionalContexts = {}, additionalAllocations) {
        return __awaiter(this, void 0, void 0, function* () {
            if (decoding.kind === "function" &&
                ...
                return yield Promise.all(decodedArray.value.map((callResult) => __awaiter(this, void 0, void 0, function* () {
                    return yield this.interpretCallInMulti(callResult, transaction, additionalContexts, additionalAllocations);
                })));
            }
            else {
                return undefined;
    ...
    interpretCallInMulti(callResult, transaction, additionalContexts = {}, additionalAllocations) {
        return __awaiter(this, void 0, void 0, function* () {
            switch (callResult.kind) {
                case "value":
                    return yield this.decodeTransactionWithAdditionalContexts(Object.assign(Object.assign({}, transaction), { input: callResult.value.asHex }), additionalContexts, additionalAllocations);
                case "error":
                    return null;
            }
        });
    }
    interpretAggregate(decoding, transaction, additionalContexts = {}, additionalAllocations) {
        return __awaiter(this, void 0, void 0, function* () {
            if (decoding.kind === "function" &&
                ...
                const decodedArray = decoding.arguments[0]
                    .value;
                return yield Promise.all(decodedArray.value.map((callResult) => __awaiter(this, void 0, void 0, function* () {
                    return yield this.interpretCallInAggregate(callResult, transaction, additionalContexts, additionalAllocations);
                })));
            }
            else {
                return undefined;
    ...
    interpretCallInAggregate(callResult, transaction, additionalContexts = {}, additionalAllocations) {
        return __awaiter(this, void 0, void 0, function* () {
            switch (callResult.kind) {
                case "value":
                    ...
                    switch (bytesResult.kind) {
                        case "value":
                            const subDecoding = yield this.decodeTransactionWithAdditionalContexts(Object.assign(Object.assign({}, transaction), { input: bytesResult.value.asHex, to: address }), additionalContexts, additionalAllocations);
    ...
    interpretTryAggregate(decoding, transaction, additionalContexts = {}, additionalAllocations) {
        return __awaiter(this, void 0, void 0, function* () {
            if (decoding.kind === "function" &&
    ...
    interpretDeadlinedMulticall(decoding, transaction, additionalContexts = {}, additionalAllocations) {
        return __awaiter(this, void 0, void 0, function* () {
            if (decoding.kind === "function" &&
                decoding.abi.name === "multicall" &&
                decoding.abi.inputs.length === 2 &&
    ...
    interpretBlockhashedMulticall(decoding, transaction, additionalContexts = {}, additionalAllocations) {
        return __awaiter(this, void 0, void 0, function* () {
            if (decoding.kind === "function" &&
                decoding.abi.name === "multicall" &&
                decoding.abi.inputs.length === 2 &&
...
function forProject(settings) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let decoder = new decoders_1.ProjectDecoder(compilations, settings.provider, ensSettings);
        yield decoder.init();
        return decoder;
    });
}
