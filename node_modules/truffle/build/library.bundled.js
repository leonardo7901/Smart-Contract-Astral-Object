...
"use strict";
module.exports = JSON.parse('{"name":"@truffle/core","description":"Core code for Truffle command line tool","license":"MIT","author":"consensys.net","homepage":"https://github.com/trufflesuite/truffle#readme","repository":{"type":"git","url":"https://github.com/trufflesuite/truffle.git","directory":"packages/core"},"bugs":{"url":"https://github.com/trufflesuite/truffle/issues"},"version":"5.9.0","bin":{"truffle":"./cli.js","truffle-exec":"./exec.js"},"scripts":{"prepare":"exit 0","test":"mocha ./test/** ./test/**/*"},"dependencies":{"@truffle/artifactor":"^4.0.189","@truffle/box":"^2.1.76","@truffle/code-utils":"^3.0.2","@truffle/codec":"^0.15.0","@truffle/compile-common":"^0.9.4","@truffle/compile-solidity":"^6.0.68","@truffle/config":"^1.3.56","@truffle/contract":"^4.6.21","@truffle/dashboard":"^0.3.18","@truffle/db-loader":"^0.2.24","@truffle/debug-utils":"^6.0.49","@truffle/debugger":"^11.1.0","@truffle/decoder":"^5.4.0","@truffle/deployer":"^3.3.15","@truffle/environment":"^0.2.148","@truffle/error":"^0.2.0","@truffle/expect":"^0.1.5","@truffle/fetch-and-compile":"^0.5.44","@truffle/from-hardhat":"^0.2.9","@truffle/hdwallet":"^0.1.2","@truffle/interface-adapter":"^0.5.33","@truffle/migrate":"^3.3.36","@truffle/plugins":"^0.2.13","@truffle/preserve":"^0.2.15","@truffle/promise-tracker":"^0.1.5","@truffle/provider":"^0.3.9","@truffle/provisioner":"^0.2.79","@truffle/require":"^2.1.31","@truffle/resolver":"^9.0.41","@truffle/source-fetcher":"^1.0.34","@truffle/spinners":"^0.2.3","@truffle/test":"^0.1.20","@truffle/workflow-compile":"^4.0.59","JSONStream":"^1.3.5","address":"^1.1.2","chai":"^4.2.0","colors":"1.4.0","command-exists":"^1.2.8","conf":"^10.0.2","debug":"^4.3.1","del":"^2.2.0","ethereum-cryptography":"1.1.2","fs-extra":"^9.1.0","ganache":"7.8.0","get-port":"^5.1.1","get-random-values":"^1.2.2","glob":"^7.1.6","inquirer":"8.2.2","iter-tools":"^7.5.0","js-interpreter":"2.2.0","lodash":"^4.17.21","mocha":"10.1.0","node-emoji":"^1.8.1","original-require":"^1.0.1","sane":"^4.0.2","semver":"7.3.7","source-map-support":"^0.5.19","spawn-args":"0.2.0","tmp":"^0.2.1","universal-analytics":"^0.4.17","uuid":"^9.0.0","web3":"1.10.0","web3-utils":"1.10.0","xregexp":"^4.2.4","yargs":"^13.3.0"},"devDependencies":{"@truffle/blockchain-utils":"^0.1.7","app-module-path":"^2.2.0","chai-as-promised":"^7.1.1","memorystream":"^0.3.1","sinon":"^9.0.2"},"publishConfig":{"access":"public"},"authors":[{"name":"Tim Coulter","email":"tim@trufflesuite.com","url":"https://github.com/tcoulter"}],"namespace":"consensys","gitHead":"97a11771e65ca8929182cccd4afcbcde2852be3b"}');
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [5158,5521,3618,7216,5674,6674,8516,406,6434,1324,8716,2765,5358,3983,4866,4722,7546,562,7337,2144,4914,9356,6062,6002,7959,8569,553,4273,5925,7017,2478,8852], () => (__webpack_require__(489244)))
