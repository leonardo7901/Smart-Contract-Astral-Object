...
var nodeCrypto = __webpack_require__(706113);
...
const {
  ...
  displayGeneralHelp
} = __webpack_require__(334763);
const { handleHelpInput } = __webpack_require__(681288);
...
// so we shim it here
global.crypto = {
  getRandomValues: __webpack_require__(261642)
};
...
function main() {
  const { getCommand, prepareOptions, runCommand } = __webpack_require__(334763);
  ...
  runCommand(command, options)
    .then(returnStatus => {
      ...
      return (__webpack_require__(916164).waitForOutstandingPromises)();
    })
    .then(() => process.exit())
    .catch(error => {
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [5158,5521,3618,7216,5674,6674,8516,406,6434,1324,8716,2765,5358,3983,4866,4722,7546,562,7337,2144,4914,9356,5898,6062,6276,7029,1327,3700,553,4273,5925,7017,2478,4986], () => (__webpack_require__(460950)))
